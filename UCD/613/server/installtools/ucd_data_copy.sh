...
# parameter to save away the relocatable directories.  Invoke with no parameters to run the docker image.
#
...
ls -al /opt/ibm-ucd/server
ls -al /opt/ibm-ucd/server/conf
ls -al /opt/ibm-ucd/server/appdata/conf
cp /opt/ibm-ucd/server/appdata/conf/server.keystore /opt/ibm-ucd/server/conf/server.keystore
ls -al /opt/ibm-ucd/server/conf
